...
use App\Models\UserModel as UsersModel;
...
class RegisterController extends ShieldRegister
{
    ...
    public function registerAction(): RedirectResponse
    {
        ...
        // Email check on penyewa and peserta_pelatihan tables
        $idUser = $user->id;
        $penyewa = $this->penyewaModel->where('email', $user->email)->first();
        if ($penyewa) {
        ...
        $peserta = $this->pesertaPelatihanModel->where('email', $user->email)->first();
        if ($peserta) {
