<div class="bg-pdin-abu-terang">
	...
	<!-- <div class="container">
		<blockquote class="instagram-media"
			data-instgrm-permalink="https://www.instagram.com/reel/CsoJ3RUudVB/?utm_source=ig_embed&amp;utm_campaign=loading"
			data-instgrm-version="14"
			style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
			<div style="padding:16px;"> <a
					href="https://www.instagram.com/reel/CsoJ3RUudVB/?utm_source=ig_embed&amp;utm_campaign=loading"
				...
				<p
					...
					<a href="https://www.instagram.com/reel/CsoJ3RUudVB/?utm_source=ig_embed&amp;utm_campaign=loading"
						style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;"
						target="_blank">A post shared by www.raysportindo.com (@raysportindo)</a></p>
			</div>
		</blockquote>
					...
					<div class="pt-1 ps-2">
						...
						<div class="input-group mb-3">
							<input type="text" class="form-control bg-light text-secondary" placeholder="" aria-label=""
								...
								value="<?= base_url() . 'rilismedia/' . $artikel['slug']?>"
								id="myInput" />
						...
						<div class="col-md-12">
							<div class="d-flex flex-grow-1 justify-content-center justify-content-xl-between flex-wrap">
								<a class="btn btn-facebook-1 m-2 m-xl-0 mb-lg-2" href="#" target=""><small><span
											class="bi bi-facebook me-2"></span>Facebook</small></a>
								<a class="btn btn-twitter-1 m-2 m-xl-0 mb-lg-2" href="#" target=""><small><span
											class="bi bi-twitter me-2"></span>Twitter</small></a>

								<a class="btn btn-linkedin-1 m-2 m-xl-0 mb-lg-2" href="#" target=""><small><span
											class="bi bi-linkedin me-2"></span>LinkedIn</small></a>
							</div>
						</div>
					</div>
					<!-- recent -->
					<div class="pt-4 ps-2">
						<h5 class="">Artikel Pilihan</h5>
						<!-- berita -->
						<div class="row mb-3 mx-0">
							<div class="card px-0 border-0">
								<div class="row g-0">
									<div class="col-3 position-relative">
										<img src="<?=base_url()?>assets/galeri-5.jpg"
