<div class="bg-white col-12 p-5" id="">
    ...
    <form method="post" action="/DashboardAdmin/saveTambahRilisMedia" class="form-container"
        ...
        <div class="col-md-3">
            ...
            <div class="mb-3">
                ...
                <input
                    ...
                    name="featured_image" onchange="onFileUpload(this);" accept="image/*">
                <div class="invalid-feedback">
