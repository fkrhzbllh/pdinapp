...
<div class="bg-white col-12 p-5">
    ...
    <form action="<?= '/DashboardAdmin/saveTambahUser' ?>" method="post">
        <?= csrf_field() ?>

        <div class="mb-3">
            <label for="email" class="form-label">Email</label>
            <div class="input-group">
                <input type="email" class="form-control" value="<?= old('email') ?>" name="email" inputmode="email" autocomplete="email" required>
            </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                <input type="username" class="form-control" value="<?= old('username') ?>" name="username" inputmode="text" autocomplete="username" required>
            </div>
            <div class="invalid-feedback">
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                <input type="text" class="form-control" value="<?= old('first_name') ?>" name="first_name" inputmode="text" autocomplete="first_name" required>
            </div>
            <div class="invalid-feedback">
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                <input type="text" class="form-control" value="<?= old('last_name') ?>" name="last_name" inputmode="text" autocomplete="last_name" required>
            </div>
            <div class="invalid-feedback">
