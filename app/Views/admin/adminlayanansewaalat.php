                                ...
                                <?php foreach ($jadwalAkanDatang as $key => $a) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- <form action="/DashboardAdmin/update-sewa-alat" method="post" class="d-inline">
                                    <?= csrf_field(); ?>
                                    <input type="hidden"
                                        value="<?php echo $a['id'] ?>"
                                        name="id">
            ...
            <!-- <?php foreach ($jadwalSudahSelesai as $key => $a) : ?>
                ...
                <div class="container px-4 py-3 my-3 rounded-3 shadow">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-6 text-center">
                            <a href="/DashboardAdmin/update-sewa-alat/<?php // echo $a['uuid'] 
...
<script>
    $(document).ready(function() {
        var table1 = $('#tablejadwal1').DataTable({
            "columns": [
                null,
                null,
                null,
