<div class="bg-white col-12 p-5" id="">
    ...
    <form method="post"
        action="/DashboardAdmin/saveUpdateRilisMedia/<?= $artikel['id'] ?>"
        ...
        <div class="row mb-3">
            <div class="col-md-9">
                <div class="mb-3">
                    ...
                    <input
                        ...
                        value="<?= (old('judul')) ? old('judul') : $artikel['judul'] ?>"
                        placeholder="Judul Artikel" required id="judul" />
            ...
            <div class="mb-3">
                ...
                <textarea
                    class="form-control tinymce <?= (validation_show_error('konten')) ? 'is-invalid' : ''; ?>"
                    rows="30" type="text" name="konten"
                    id="konten"><?= (old('konten')) ? old('konten') : $artikel['konten'] ?></textarea>
                <div class="invalid-feedback">
        ...
        <div class="col-md-3">
            <div class="mb-3">
                ...
                <textarea
                    class="form-control overlayscollbar <?= (validation_show_error('meta_description')) ? 'is-invalid' : ''; ?>"
                    rows="5" type="text" name="meta_description"
                    id="meta_description"><?= (old('meta_description')) ? old('meta_description') : $artikel['meta_description'] ?></textarea>
                <div class="invalid-feedback">
            ...
            <div class="mb-3">
                ...
                <textarea
                    class="form-control overlayscollbar <?= (validation_show_error('excerp')) ? 'is-invalid' : ''; ?>"
                    rows="5" type="text" name="excerp"
                    id="excerp"><?= (old('excerp')) ? old('excerp') : $artikel['excerp'] ?></textarea>
                <div class="invalid-feedback">
            ...
            <div class="mb-3">
                ...
                <input
                    class="form-control <?= (validation_show_error('kategori')) ? 'is-invalid' : ''; ?>"
                    type="text" name="kategori" id="kategori"
                    value="<?= (old('kategori')) ? old('kategori') : $artikel['kategori'] ?>"
            ...
            <div class="mb-3">
                ...
                <select
                    ...
                    aria-label="Default select" id="status" name="status">
            ...
            <div class="mb-3">
                ...
                <input id="tgl_terbit"
                    class="form-control <?= (validation_show_error('tgl_terbit')) ? 'is-invalid' : ''; ?>"
                    type="datetime-local" name="tgl_terbit"
                    value="<?= (old('tgl_terbit')) ? old('tgl_terbit') : $artikel['tgl_terbit'] ?>" />
                <div class="invalid-feedback">
                    <?= validation_show_error('tgl_terbit'); ?>
                </div>
            </div>
            <div class="mb-3">
                <label for="featured_image" class="form-label"><a class="btn btn-danger" role="button"
                        aria-disabled="false">Ganti Foto featured_image</a></label>
                <input
                    class="form-control <?= (validation_show_error('featured_image')) ? 'is-invalid' : ''; ?>"
                    type="file" id="featured_image"
                    value="<?= old('featured_image') ?>"
                    name="featured_image" style="display:none">
                <div class="invalid-feedback">
                ...
                <label for="featured_image"
                    class="custom-file-label"><?= $artikel['featured_image'] ?></label>
                <!-- preview foto -->
                <div class="filearray col-sm-2" id="preview">
                    <img src="<?= base_url() . 'uploads/' . $artikel['featured_image'] ?>"
