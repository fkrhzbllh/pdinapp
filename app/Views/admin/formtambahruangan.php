...
<div class="bg-white col-12 p-5" id="">
    ...
    <form id="formruangan" class="mt-3" action="/DashboardAdmin/saveTambahRuangan" method="post" enctype="multipart/form-data">
        <?php echo csrf_field() ?>
        <div class="row g-3">
            ...
            <div class="col-12">
                ...
                <textarea class="form-control <?= (validation_show_error('deskripsiRuangan')) ? 'is-invalid' : ''; ?>" id="deskripsiRuangan" placeholder="" value="<?= old('deskripsiRuangan') ?>" name="deskripsiRuangan"><?= old('deskripsiRuangan') ?></textarea>
                <div class="invalid-feedback">
            ...
            <div class="col-12">
                ...
                <textarea class="form-control <?= (validation_show_error('kegunaan')) ? 'is-invalid' : ''; ?>" id="kegunaan" placeholder="" value="<?= old('kegunaan') ?>" name="kegunaan"></textarea>
                <div class="invalid-feedback">
            ...
            <div class="col-6">
                ...
                <input class="form-control <?= (validation_show_error('fotoruangan[]')) ? 'is-invalid' : ''; ?>" type="file" id="fotoruangan" multiple value="<?= old('fotoruangan[]') ?>" name="fotoruangan[]" onchange="onFileUpload(this);">
                <div class="invalid-feedback">
