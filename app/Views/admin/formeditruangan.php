...
<section id="isi-section">
    <div class="container p-3">
        <div class="bg-white rounded-5 py-5 px-5 shadow-sm" id="">
            <form id="formruangan" class="mt-3"
                action="/DashboardAdmin/saveUpdateRuangan/<?= $ruangan['id'] ?>"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text"
                            ...
                            id="nama" placeholder=""
                            value="<?= (old('nama')) ? old('nama') : $ruangan['nama'] ?>"
                            name="nama" autofocus>
                    ...
                    <div class="col-12">
                        ...
                        <textarea
                            ...
                            id="deskripsiRuangan" placeholder="" value=""
                            name="deskripsiRuangan"><?= (old('deskripsiRuangan')) ? old('deskripsiRuangan') : $ruangan['deskripsi'] ?></textarea>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-12">
                        ...
                        <textarea
                            ...
                            id="kegunaan" placeholder="" value=""
                            name="kegunaan"><?= (old('kegunaan')) ? old('kegunaan') : $ruangan['kegunaan'] ?></textarea>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-4">
                        ...
                        <input type="number"
                            ...
                            value="<?= (old('kapasitas')) ? old('kapasitas') : $ruangan['kapasitas'] ?>"
                            name="kapasitas">
                        <div class="invalid-feedback">
                    ...
                    <div class="col-4">
                        ...
                        <input type="number"
                            ...
                            value="<?= (old('panjang')) ? old('panjang') : $panjang ?>"
                            name="panjang">
                        <div class="invalid-feedback">
                    ...
                    <div class="col-4">
                        ...
                        <input type="number"
                            ...
                            value="<?= (old('lebar')) ? old('lebar') : $lebar ?>"
                            name="lebar">
                        <div class="invalid-feedback">
                    ...
                    <div class="col-4">
                        ...
                        <input type="number"
                            ...
                            value="<?= (old('tinggi')) ? old('tinggi') : $tinggi ?>"
                            name="tinggi">
                        <div class="invalid-feedback">
                    ...
                    <div class="col-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="1000"
                                ...
                                id="biaya-sewa"
                                value="<?= (old('biayasewa')) ? old('biayasewa') : $ruangan['biaya_sewa'] ?>"
                                name="biayasewa">
                        </div>
                        <div class="invalid-feedback">
        ...
        <p class="mt-5 text-center">
            ...
            <input type="file" name="fotoruangan[]" id="fotoruangan" style="visibility: hidden; position: absolute;"
                multiple />
