...
<!-- Fasilitas Section -->
<section id="" class="section-bg-pdin-quaternary">
	<!--judul section  -->
		...
		<div class="text-center">
			...
			<div class="row justify-content-center mb-5">
				<div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-7 col-xxl-7">
					<p class="text-light mb-3 lh-base" data-aos="fade-up" data-aos-delay="350">
						Pusat Desain Industri Nasional menyediakan berbagai fasilitas
						yang bisa digunakan oleh seluruh pelaku industri kreatif
						...
						?>
							<div class="swiper-slide">
								<div class="card border-0">
									<img class="rounded-2" src="<?= base_url() ?>uploads/<?= $fotoruangan[$key]['nama_file'] ?>" />
	...
	<div class="d-flex mt-5 text-center justify-content-center mb-5">
		<div class="w-15">
			<a class="btn btn-outline-light d-md-block" href="/fasilitas" role="button">Lihat Semua Fasilitas <span class="ps-1 bi-arrow-right"></span></a>
		</div>
	</div>
</section>
...
<section class="">
	<div class="container p-3" data-aos="fade-up">
		<!-- Judul -->
		<div class="text-center">
			<h3 class="text-black highlight-header mb-4">KEGIATAN</h3>
			<div class="row justify-content-center mb-5">
				<div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-7 col-xxl-7">
					<p class="text-black lh-base mb-3">
						Pusat Desain Industri Nasional menyelenggarakan berbagai
						kegiatan kreatif sebagai dukungan untuk mengembangkan industri
		...
		<div class="row bg-white rounded-4 p-2 p-sm-4 pb-2">
			...
			<div class="col-md-6 col-xl-4 p-2 mb-3">
				<div class="">
					<div class="bg-pdin-quaternary p-4 pb-2 rounded-top-4">
						<h5 class="text-white mt-2">Agenda Kegiatan di PDIN</h5>
						<p class="text-white">
							Informasi mengenai daftar kegiatan di Pusat Desain Industri
							Nasional
						</p>
					</div>
		...
		<div class="text-center mt-4 mt-lg-5 mt-xl-4 mt-xxl-4">
			<a class="btn btn-outline-danger" href="/rilis-media" role="button">Lihat Semua
				Kegiatan
