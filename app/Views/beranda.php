		...
		<div class="text-center">
			...
			<div class="row justify-content-center mb-5">
				<div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-7 col-xxl-7">
					<p class="section-description text-black mb-3 lh-base">
						Pusat Desain Industri Nasional berkomitmen untuk menyediakan
						layanan yang prima sehingga industri kreatif dalam negeri dapat
...
<!-- End Garis Batas -->
<!-- Fasilitas Section -->
<section id="" class="section-bg-black">
	<!--judul section  -->
	<div class="container p-3">
		...
		<div class="text-center">
			...
			<div class="row justify-content-center mb-5">
				<div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-7 col-xxl-7">
					<p class="text-light mb-3 section-description lh-base" data-aos="fade-up" data-aos-delay="350">
...
<section class="section-bg-white">
	<div class="container p-3" data-aos="fade-up">
		...
		<div class="text-center">
			...
			<div class="row justify-content-center mb-5">
				<div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-7 col-xxl-7">
					<p class="text-black section-description lh-base mb-3">
...
<section id="" class="section-bg-black">
	<div class="container p-3">
		...
		<div class="text-center">
			...
			<div class="row justify-content-center mb-5">
				<div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-7 col-xxl-7">
					<p class="text-light lh-base mb-0 section-description" data-aos="fade-up" data-aos-delay="350">
