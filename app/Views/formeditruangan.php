...
<section id="isi-section">
    <div class="container p-3">
        <div class="bg-white rounded-5 py-5 px-5 shadow-sm" id="">
            <form id="formruangan" class="mt-3" action="/admin/saveUpdateRuangan/<?= $ruangan['id'] ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field() ?>
                <div class="row g-3">
                    <h3><?= $judul_halaman ?></h3>
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control <?= (validation_show_error('deskripsiRuangan')) ? 'is-invalid' : ''; ?>" id="deskripsiRuangan" placeholder="" value="" name="deskripsiRuangan" style="height: 200px;"><?= (old('deskripsiRuangan')) ? old('deskripsiRuangan') : $ruangan['deskripsi'] ?></textarea>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control <?= (validation_show_error('kegunaan')) ? 'is-invalid' : ''; ?>" id="kegunaan" placeholder="" value="" name="kegunaan"><?= (old('kegunaan')) ? old('kegunaan') : $ruangan['kegunaan'] ?></textarea>
                        <div class="invalid-feedback">
