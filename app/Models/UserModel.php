...
class UserModel extends ShieldUserModel
{
    ...
    public function getAll()
    {
        ...
        return $this->db->query('SELECT u.id, u.username, u.first_name, u.last_name, u.uuid, agu.group FROM users u JOIN auth_groups_users agu ON u.id = agu.user_id')->getResultArray();
    }
